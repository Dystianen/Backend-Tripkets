...
class PlaneController extends Controller
{
    ...
    public function getAll($limit = NULL, $offset = NULL)
    {
        ...
        if($limit == NULL && $offset == NULL){
            $data['transportations'] = Transportation::with('category')->where("id_category","=","3")->get();
        }else{
            $data['transportations'] = Transportation::with('category')->where("id_category","=","3")->get()->take($limit)->skip($offset)->get();
        }
